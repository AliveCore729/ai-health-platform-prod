  ...
  const diseases = [
    {
      id: "psoriasis",
      title: "Psoriasis",
      description: "Autoimmune skin condition screening",
      status: "deploying",
    },
    {
      id: "skin_cancer",
      title: "Skin Cancer",
      description: "Dermatological lesion analysis",
      status: "deploying", // change to "active" later
    },
  ];
